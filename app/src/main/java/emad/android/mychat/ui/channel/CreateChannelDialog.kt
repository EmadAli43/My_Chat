package emad.android.mychat.ui.channel
...
import emad.android.mychat.databinding.DialogChannelNameBinding
...
class CreateChannelDialog: DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return MaterialAlertDialogBuilder(requireContext())
            ...
            .setNegativeButton(R.string.cancel) { dialogIterface, _ ->
